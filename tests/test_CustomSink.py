...
class ComponentTests(ossie.utils.testing.ScaComponentTestCase):
    ...
    def testA(self):
        self.runTest(clientFirst=True, client = 'CustomSink', dataPackets=self.OCTET_DATA,portType='octet')
    def testB(self):
        self.runTest(clientFirst=False, client = 'CustomSink', dataPackets=self.OCTET_DATA,portType='octet')
    def testC(self):
        self.runTest(clientFirst=True, client = 'CustomSource', dataPackets=self.OCTET_DATA,portType='octet')
    def testD(self):
        self.runTest(clientFirst=False, client = 'CustomSource', dataPackets=self.OCTET_DATA,portType='octet')

    def testAChar(self):
        self.runTest(clientFirst=True, client = 'CustomSink', dataPackets=self.CHAR_DATA,portType='char')
    def testBChar(self):
        self.runTest(clientFirst=False, client = 'CustomSink', dataPackets=self.CHAR_DATA,portType='char')
    def testCChar(self):
        self.runTest(clientFirst=True, client = 'CustomSource', dataPackets=self.CHAR_DATA,portType='char')
    def testDChar(self):
        self.runTest(clientFirst=False, client = 'CustomSource', dataPackets=self.CHAR_DATA,portType='char')

    def testAUShort(self):
        self.runTest(clientFirst=True, client = 'CustomSink', dataPackets=self.U_SHORT_DATA,portType='ushort')
    def testBUShort(self):
        self.runTest(clientFirst=False, client = 'CustomSink', dataPackets=self.U_SHORT_DATA,portType='ushort')
    def testCUShort(self):
        self.runTest(clientFirst=True, client = 'CustomSource', dataPackets=self.U_SHORT_DATA,portType='ushort')
    def testDUShort(self):
        self.runTest(clientFirst=False, client = 'CustomSource', dataPackets=self.U_SHORT_DATA,portType='ushort')

    def testAShort(self):
        self.runTest(clientFirst=True, client = 'CustomSink', dataPackets=self.SHORT_DATA,portType='short')
    def testBShort(self):
        self.runTest(clientFirst=False, client = 'CustomSink', dataPackets=self.SHORT_DATA,portType='short')
    def testCShort(self):
        self.runTest(clientFirst=True, client = 'CustomSource', dataPackets=self.SHORT_DATA,portType='short')
    def testDShort(self):
        self.runTest(clientFirst=False, client = 'CustomSource', dataPackets=self.SHORT_DATA,portType='short')

    def testAULong(self):
        self.runTest(clientFirst=True, client = 'CustomSink', dataPackets=self.U_LONG_DATA,portType='ulong')
    def testBULong(self):
        self.runTest(clientFirst=False, client = 'CustomSink', dataPackets=self.U_LONG_DATA,portType='ulong')
    def testCULong(self):
        self.runTest(clientFirst=True, client = 'CustomSource', dataPackets=self.U_LONG_DATA,portType='ulong')
    def testDULong(self):
        self.runTest(clientFirst=False, client = 'CustomSource', dataPackets=self.U_LONG_DATA,portType='ulong')

    def testALong(self):
        self.runTest(clientFirst=True, client = 'CustomSink', dataPackets=self.LONG_DATA,portType='long')
    def testBLong(self):
        self.runTest(clientFirst=False, client = 'CustomSink', dataPackets=self.LONG_DATA,portType='long')
    def testCLong(self):
        self.runTest(clientFirst=True, client = 'CustomSource', dataPackets=self.LONG_DATA,portType='long')
    def testDLong(self):
        self.runTest(clientFirst=False, client = 'CustomSource', dataPackets=self.LONG_DATA,portType='long')

    def testAFloat(self):
        self.runTest(clientFirst=True, client = 'CustomSink', dataPackets=self.FLOAT_DATA,portType='float')
    def testBFloat(self):
        self.runTest(clientFirst=False, client = 'CustomSink', dataPackets=self.FLOAT_DATA,portType='float')
    def testCFloat(self):
        self.runTest(clientFirst=True, client = 'CustomSource', dataPackets=self.FLOAT_DATA,portType='float')
    def testDFloat(self):
        self.runTest(clientFirst=False, client = 'CustomSource', dataPackets=self.FLOAT_DATA,portType='float')

    def testADouble(self):
        self.runTest(clientFirst=True, client = 'CustomSink', dataPackets=self.DOUBLE_DATA,portType='double')
    def testBDouble(self):
        self.runTest(clientFirst=False, client = 'CustomSink', dataPackets=self.DOUBLE_DATA,portType='double')
    def testCDouble(self):
        self.runTest(clientFirst=True, client = 'CustomSource', dataPackets=self.DOUBLE_DATA,portType='double')
    def testDDouble(self):
        self.runTest(clientFirst=False, client = 'CustomSource', dataPackets=self.DOUBLE_DATA,portType='double')

    #test a bunch of stuff.  Vary which one is the client.  Vary the data ports as well
    def testAMultiConnection(self):
        self.runMultiConnectionTest(client = 'CustomSink', dataPackets=self.OCTET_DATA,portType='octet')
    
    def testBMultiConnection(self):
        self.runMultiConnectionTest(client = 'CustomSource', dataPackets=self.OCTET_DATA,portType='octet')

    def testAMultiConnectionChar(self):
        self.runMultiConnectionTest(client = 'CustomSink', dataPackets=self.CHAR_DATA,portType='char')
    def testBMultiConnectionChar(self):
        self.runMultiConnectionTest(client = 'CustomSource', dataPackets=self.CHAR_DATA,portType='char')

    def testAMultiConnectionUShort(self):
        self.runMultiConnectionTest(client = 'CustomSink', dataPackets=self.U_SHORT_DATA,portType='ushort')
    def testBMultiConnectionUShort(self):
        self.runMultiConnectionTest(client = 'CustomSource', dataPackets=self.U_SHORT_DATA,portType='ushort')

    def testAMultiConnectionShort(self):
        self.runMultiConnectionTest(client = 'CustomSink', dataPackets=self.SHORT_DATA,portType='short')
    def testBMultiConnectionShort(self):
        self.runMultiConnectionTest(client = 'CustomSource', dataPackets=self.SHORT_DATA,portType='short')

    def testAMultiConnectionULong(self):
        self.runMultiConnectionTest(client = 'CustomSink', dataPackets=self.U_LONG_DATA,portType='ulong')
    def testBMultiConnectionULong(self):
        self.runMultiConnectionTest(client = 'CustomSource', dataPackets=self.U_LONG_DATA,portType='ulong')

    def testAMultiConnectionLong(self):
        self.runMultiConnectionTest(client = 'CustomSink', dataPackets=self.LONG_DATA,portType='long')
    def testBMultiConnectionLong(self):
        self.runMultiConnectionTest(client = 'CustomSource', dataPackets=self.LONG_DATA,portType='long')

    def testAMultiConnectionFloat(self):
        self.runMultiConnectionTest(client = 'CustomSink', dataPackets=self.FLOAT_DATA,portType='float')
    def testBMultiConnectionFloat(self):
        self.runMultiConnectionTest(client = 'CustomSource', dataPackets=self.FLOAT_DATA,portType='float')

    def testAMultiConnectionDouble(self):
        self.runMultiConnectionTest(client = 'CustomSink', dataPackets=self.DOUBLE_DATA,portType='double')
    def testBMultiConnectionDouble(self):
        self.runMultiConnectionTest(client = 'CustomSource', dataPackets=self.DOUBLE_DATA,portType='double')

    #Test sending a bunch of little packets
    def testLITTLE_PACKETS(self):
        print "testLITTLE_PACKETS"
        self.runTest(clientFirst=True, client = 'CustomSink', dataPackets=[range(200) for _ in xrange(50000)], maxBytes=256*256, minBytes=0)

    def testLITTLE_PACKETS_2(self):
        print "testLITTLE_PACKETS_2"
        self.runTest(clientFirst=True, client = 'CustomSource', dataPackets=[range(200) for _ in xrange(50000)], maxBytes=256*256, minBytes=0)     

    #Test sending two BIG PACKETS
    def testBIG_PACKETS(self):
        print "testBIG_PACKETS"
        self.runTest(clientFirst=True, client = 'CustomSink', dataPackets=[range(200)*25000 for _ in xrange(2)])
    def testBIG_PACKETS_2(self):
        print "testBIG_PACKETS_2"
        self.runTest(clientFirst=True, client = 'CustomSource', dataPackets=[range(200)*25000 for _ in xrange(2)])
    ...
    def testByteSwap1(self):
        TYPE= 'octet'
        SWAP = 2
        self.runTest(client = 'CustomSource', dataPackets=[range(0,100)*10], byteSwapSrc=None, byteSwapSink=SWAP,minBytes=1,portType=TYPE)
    ...
    def testByteSwap2(self):
        TYPE= 'octet'
        SWAP = 2
        self.runTest(client = 'CustomSource', dataPackets=[range(0,100)*10], byteSwapSrc=SWAP, byteSwapSink=None,minBytes=1,portType=TYPE)
        s= toStr(self.input,TYPE)
        so = toStr(self.output,TYPE)
        f= flip(so,SWAP)
        self.assertEqual(s[:len(f)],f)
    ...
    def testByteSwap9(self):
        TYPE= 'octet'
        SWAP = 10
        self.runTest(client = 'CustomSource', dataPackets=[range(0,100)*10], byteSwapSrc=SWAP, byteSwapSink=SWAP,minBytes=1,portType=TYPE)
        s= toStr(self.input,TYPE)
        so = toStr(self.output,TYPE)
    ...
    def testByteSwap25(self):
        TYPE= 'short'
        SWAP = 5
        self.runTest(client = 'CustomSource', dataPackets=[range(0,99)]*9, byteSwapSrc=None, byteSwapSink=SWAP,minBytes=1,portType=TYPE)
        s= toStr(self.input,TYPE)
        so = toStr(self.output,TYPE)
        f= flip(so,SWAP)
        self.assertEqual(s[:len(f)],f)
    ...
    def testByteSwap26(self):
        TYPE= 'short'
        SWAP = 5
        self.runTest(client = 'CustomSource', dataPackets=[range(0,99)]*9, byteSwapSrc=SWAP, byteSwapSink=None,minBytes=1,portType=TYPE)
        s= toStr(self.input,TYPE)
        so = toStr(self.output,TYPE)
        f= flip(so,SWAP)
        self.assertEqual(s[:len(f)],f)
    ...
    def runTest(self, clientFirst=True, client = 'CustomSink',dataPackets=[],maxBytes=None,minBytes=None, portType='octet',byteSwapSrc=None, byteSwapSink=None):
...
##        
    ...
    def runMultiConnectionTest(self, client = 'CustomSink',dataPackets=[],maxBytes=None,minBytes=None, portType='octet',byteSwapSrc=None, byteSwapSink=None):
...
if __name__ == "__main__":
    ossie.utils.testing.main("../CustomSink.spd.xml") # By default tests all implementations
